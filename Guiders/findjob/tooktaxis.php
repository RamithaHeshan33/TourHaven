<?php
    ...
    $tookjobs = "SELECT * FROM emergency WHERE guider_mail = ? AND status = 'Pending'";
...
<body>
    <div class="container">
        <div class="top">
            <h1>Your Taxi Jobs</h1>
            <button class="btn" onclick="window.location.href='donetaxi.php'">Done Jobs</button>
        </div>
        <table>
            <thead>
                <tr>
    ...
    <script>
        ...
        document.getElementById("confirmButton").addEventListener("click", function() {
            if (currentJobId) {
                ...
                xhr.open("POST", "update_taxi_status.php", true);
                xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                xhr.onload = function() {
                    if (xhr.status === 200) {
                        window.location.href = "donetaxi.php";
                    } else {
